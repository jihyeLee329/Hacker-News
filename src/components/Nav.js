...
color:${(props) => props.theme.grayColor}; border-bottom: 1px solid ${(props) => props.theme.borderColor};
  &.active{position:relative;color:${(props) => props.theme.mainColor};font-weight:bold;}
  &.active:after{content:""; width:100%; height:2px; background:${(props) => props.theme.mainColor}; position:absolute; left:0; bottom:0; border-radius: 2px 2px 0px 0px;}
};
`;
